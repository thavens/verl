...
experiment_name='qwen4b_pir_sft_50_sys_pir_grpo'
...
uv run python -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=thavens/qwen4b_pir_sft_50_sys_grpo \
    ...
    trainer.default_local_dir="/bucket/${project_name}/${experiment_name}"