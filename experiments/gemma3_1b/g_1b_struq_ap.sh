...
experiment_name='g3_1b_struq_ap'
...
uv run python -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/scratch/public_models/huggingface/Qwen/Qwen2.5-0.5B-Instruct \
    ...
    critic.model.path=/scratch/public_models/huggingface/Qwen/Qwen2.5-0.5B-Instruct \
